...
STEERING_LEFT_PWM = 265         #pwm value for full left steering
STEERING_RIGHT_PWM = 475        #pwm value for full right steering
# 
# #THROTTLE
...
THROTTLE_REVERSE_PWM = 265      #pwm value for max reverse throttle
# 
